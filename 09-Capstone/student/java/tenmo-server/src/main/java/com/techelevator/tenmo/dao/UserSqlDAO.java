...
public class UserSqlDAO implements UserDAO {
    ...
    @Override
    public User getUserWithAccount(int AccountNumber) throws UsernameNotFoundException {
    	User user = null;
        SqlRowSet row = jdbcTemplate.queryForRowSet("select * from users u "
        ...
        throw new UsernameNotFoundException("User with Account# " + AccountNumber + " was not found.");
        }
